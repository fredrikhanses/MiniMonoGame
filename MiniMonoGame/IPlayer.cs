...
namespace MiniMonoGame
{
    public interface IPlayer
    {
        ...
        int BaseHealth { get; }
        bool Dead { get; }
        void Init(Vector2 position, Vector2 scale, float rotation = 0.0f, float speed = 200.0f, float rotationSpeed = 2.0f, float movementTolerance = 1.0f, int numberOfBullets = 100, int health = 10, int damage = 1);
